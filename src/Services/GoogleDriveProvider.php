...
class GoogleDriveProvider implements CloudStorageProviderInterface {
    public function connect(string $code): array {
        return ['access_token' => 'mock_google_access_token', 'refresh_token' => 'mock_google_refresh_token', 'expires_in' => 3600];
    }
    ...
    public function startUpload(string $filePath, string $remoteName): array {
        return ['session_url' => 'http://localhost/mock-google-resumable-session', 'bytes_uploaded' => 0];
    }
