...
class UpdateStateMachine {
    ...
    private static $allowedTransitions = [
        self::STATE_PENDING => [self::STATE_CHECKING_RELEASE, self::STATE_WAITING_FOR_LOCK, self::STATE_FAILED],
        self::STATE_CHECKING_RELEASE => [self::STATE_DOWNLOADING, self::STATE_FAILED],
        self::STATE_DOWNLOADING => [self::STATE_VERIFYING_PACKAGE, self::STATE_WAITING_FOR_LOCK, self::STATE_FAILED],
        self::STATE_VERIFYING_PACKAGE => [self::STATE_EXTRACTING, self::STATE_FAILED],
        self::STATE_EXTRACTING => [self::STATE_RUNNING_PRECHECKS, self::STATE_RUNNING_MIGRATIONS, self::STATE_FAILED],
        ...
        self::STATE_BACKING_UP_DATABASE => [self::STATE_VERIFYING_PACKAGE, self::STATE_VALIDATING_BACKUPS, self::STATE_FAILED],
        self::STATE_VALIDATING_BACKUPS => [self::STATE_RUNNING_MIGRATIONS, self::STATE_FAILED],
        self::STATE_RUNNING_MIGRATIONS => [self::STATE_RUNNING_SEED_UPDATES, self::STATE_VALIDATING_APPLICATION, self::STATE_FAILED],
        ...
        self::STATE_FAILED => [self::STATE_ROLLING_BACK, self::STATE_RESTORING_DATABASE, self::STATE_RESTORING_FILES, self::STATE_VALIDATING_ROLLBACK, self::STATE_ROLLED_BACK, self::STATE_ROLLBACK_FAILED],
        self::STATE_ROLLING_BACK => [self::STATE_RESTORING_DATABASE, self::STATE_RESTORING_FILES, self::STATE_VALIDATING_ROLLBACK, self::STATE_ROLLED_BACK, self::STATE_ROLLBACK_FAILED],
        self::STATE_RESTORING_DATABASE => [self::STATE_RESTORING_FILES, self::STATE_VALIDATING_ROLLBACK, self::STATE_ROLLBACK_FAILED],
