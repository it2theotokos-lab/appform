...
class UpdateStateMachine {
    ...
    private static $allowedTransitions = [
        ...
        self::STATE_FAILED => [self::STATE_ROLLING_BACK, self::STATE_RESTORING_DATABASE, self::STATE_RESTORING_FILES, self::STATE_ROLLED_BACK, self::STATE_ROLLBACK_FAILED],
        self::STATE_ROLLING_BACK => [self::STATE_RESTORING_DATABASE, self::STATE_RESTORING_FILES, self::STATE_ROLLED_BACK, self::STATE_ROLLBACK_FAILED],
