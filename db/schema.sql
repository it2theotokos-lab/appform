...
CREATE TABLE IF NOT EXISTS form_submissions (
    ...
    status ENUM('draft', 'submitted', 'correction_requested', 'under_review', 'approved', 'rejected', 'returned', 'cancelled') DEFAULT 'submitted',
...
CREATE TABLE IF NOT EXISTS submission_correction_requests (
    ...
    original_status ENUM('submitted', 'under_review', 'approved', 'rejected') NOT NULL,
